...
/// Decodes a realistic `config/entity_registry/list` row — with the extra keys HA actually sends
/// alongside `platform`/`unique_id` — through the exact decoder `HomeConnection.decodeList` uses.
